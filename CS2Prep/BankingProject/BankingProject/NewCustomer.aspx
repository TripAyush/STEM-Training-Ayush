<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewCustomer.aspx.cs" Inherits="BankingProject.NewCustomer" %>
...
<body>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style4" style="text-align:center">Gender</td>
            <td class="auto-style5">
                <asp:RadioButton ID="rmale" runat="server" Text="Male" />
                <asp:RadioButton ID="rfemale" runat="server" Text="Female" />
                <asp:RadioButton ID="rother" runat="server" Text="Other" />
            </td>
