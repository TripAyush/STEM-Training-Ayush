--Identify And Create the Tables
...
--Insert Transaction/Update Accounts
create proc sp_InsertTransaction(@accno bigint,@tt varchar(30),@tamt money,@tid int out)
as
begin
...
select @tid=@@IDENTITY
-- select Balance from Accounts where AccountNo = @accno
end