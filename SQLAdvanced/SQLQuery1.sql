...
select ename,job,deptno,sal,FIRST_VALUE(ename) over (order by sal) as 'FIRST VALUE' from emp

select ename,job,deptno,sal,LAST_VALUE(ename) over (order by sal) as 'LAST VALUE' from emp
